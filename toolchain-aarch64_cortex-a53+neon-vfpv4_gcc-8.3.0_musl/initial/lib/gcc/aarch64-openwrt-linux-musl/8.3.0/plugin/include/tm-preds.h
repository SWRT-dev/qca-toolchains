/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/paldier/qsdk/qsdk12/qsdk/build_dir/toolchain-aarch64_cortex-a53+neon-vfpv4_gcc-8.3.0_musl/gcc-8.3.0/gcc/config/aarch64/aarch64.md'.  */
