/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/paldier/qsdk/qsdk12/qsdk/build_dir/toolchain-arm_cortex-a7+neon-vfpv4_gcc-8.3.0_musl_eabi/gcc-8.3.0/gcc/config/arm/arm.md'.  */
