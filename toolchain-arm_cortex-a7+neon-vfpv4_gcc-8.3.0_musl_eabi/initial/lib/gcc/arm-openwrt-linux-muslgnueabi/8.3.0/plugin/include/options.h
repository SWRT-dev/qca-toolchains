...
enum opt_code
{
  ...
  OPT_mabi_ = 1191,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1192,             /* -mabort-on-noreturn */
  ...
  OPT_mbionic = 1204,                        /* -mbionic */
  OPT_mbranch_cost_ = 1205,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1206,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1207,     /* -mcaller-super-interworking */
  OPT_mcmse = 1208,                          /* -mcmse */
  OPT_mcpu_ = 1209,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1210,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1211,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1212,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1213,                  /* -mfp16-format= */
  OPT_mfpu_ = 1214,                          /* -mfpu= */
  OPT_mglibc = 1215,                         /* -mglibc */
