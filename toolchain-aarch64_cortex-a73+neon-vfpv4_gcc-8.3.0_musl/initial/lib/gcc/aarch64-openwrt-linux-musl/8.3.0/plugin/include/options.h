...
enum opt_code
{
  ...
  OPT_fhonour_copts = 721,                   /* -fhonour-copts */
  ...
  OPT_fshrink_wrap_separate = 983,           /* -fshrink-wrap-separate */
  OPT_fsign_zero = 984,                      /* -fsign-zero */
  OPT_fsignaling_nans = 985,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 986,               /* -fsigned-bitfields */
  OPT_fsigned_char = 987,                    /* -fsigned-char */
  OPT_fsigned_zeros = 988,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 989,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 990,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 991,             /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 992,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 993,                    /* -fsplit-loops */
  ...
  OPT_fstack_clash_protection = 1004,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1005,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1006,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1007,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1008,               /* -fstack-protector */
  OPT_fstack_protector_all = 1009,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1010,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1011,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1012,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1013,                   /* -fstack-usage */
  OPT_fstats = 1014,                         /* -fstats */
  OPT_fstdarg_opt = 1015,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1016,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1017, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1018,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1019,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1020,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1021, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1022,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1023, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1024,            /* -fstrong-eval-order= */
  ...
  OPT_ftest_forall_temp = 1033,              /* -ftest-forall-temp */
  ...
  OPT_ftime_report_details = 1038,           /* -ftime-report-details */
  ...
  OPT_ftrampolines = 1044,                   /* -ftrampolines */
  ...
  OPT_fwrapv_pointer = 1135,                 /* -fwrapv-pointer */
  ...
  OPT_g = 1140,                              /* -g */
  OPT_gant = 1141,                           /* -gant */
  OPT_gas_loc_support = 1142,                /* -gas-loc-support */
  OPT_gas_locview_support = 1143,            /* -gas-locview-support */
  /* OPT_gcoff = 1144, */                    /* -gcoff */
  /* OPT_gcoff1 = 1145, */                   /* -gcoff1 */
  /* OPT_gcoff2 = 1146, */                   /* -gcoff2 */
  /* OPT_gcoff3 = 1147, */                   /* -gcoff3 */
  OPT_gcolumn_info = 1148,                   /* -gcolumn-info */
  OPT_gdwarf = 1149,                         /* -gdwarf */
  OPT_gdwarf_ = 1150,                        /* -gdwarf- */
  OPT_gen_decls = 1151,                      /* -gen-decls */
  OPT_ggdb = 1152,                           /* -ggdb */
  OPT_ggnu_pubnames = 1153,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1154,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1155, /* -ginternal-reset-location-views */
  OPT_gnat = 1156,                           /* -gnat */
  OPT_gnatO = 1157,                          /* -gnatO */
  OPT_gno_ = 1158,                           /* -gno- */
  OPT_gno_pubnames = 1159,                   /* -gno-pubnames */
  OPT_gpubnames = 1160,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1161,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1162,                   /* -gsplit-dwarf */
  OPT_gstabs = 1163,                         /* -gstabs */
  OPT_gstabs_ = 1164,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1165,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1166,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1167,                        /* -gtoggle */
  OPT_gvariable_location_views = 1168,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1169,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1170,                           /* -gvms */
  OPT_gxcoff = 1171,                         /* -gxcoff */
  OPT_gxcoff_ = 1172,                        /* -gxcoff+ */
  OPT_gz = 1173,                             /* -gz */
  OPT_gz_ = 1174,                            /* -gz= */
  OPT_h = 1175,                              /* -h */
  OPT_idirafter = 1176,                      /* -idirafter */
  OPT_imacros = 1177,                        /* -imacros */
  OPT_imultiarch = 1178,                     /* -imultiarch */
  OPT_imultilib = 1179,                      /* -imultilib */
  OPT_include = 1180,                        /* -include */
  OPT_iplugindir_ = 1181,                    /* -iplugindir= */
  OPT_iprefix = 1182,                        /* -iprefix */
  OPT_iquote = 1183,                         /* -iquote */
  OPT_isysroot = 1184,                       /* -isysroot */
  OPT_isystem = 1185,                        /* -isystem */
  OPT_iwithprefix = 1186,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1187,              /* -iwithprefixbefore */
  OPT_k8 = 1188,                             /* -k8 */
  OPT_l = 1189,                              /* -l */
  OPT_lang_asm = 1190,                       /* -lang-asm */
  OPT_mabi_ = 1191,                          /* -mabi= */
  ...
  OPT_mglibc = 1200,                         /* -mglibc */
  OPT_mlittle_endian = 1201,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1202,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1203,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1204,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1205,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1206,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1207,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1208,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1209,          /* -msign-return-address= */
  OPT_mstrict_align = 1210,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1211,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1212,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1213,                     /* -mtls-size= */
